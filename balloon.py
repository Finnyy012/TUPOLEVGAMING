...
class Balloon:
    ...
    - sprite (pygame.surface): optional sprite with contents of target.
    ...
    def is_hit(self, point: tuple) -> bool:
        """
        This function checks if the balloon is hit.
        
        :param point: position of the event that needs to be checked 
                        (tuple) (pygame.event.pos) 
        :return: bool
        """
...
def load_multiple_types_balloons(ground_height: int, target_count: int) -> list[Balloon]:
    """
